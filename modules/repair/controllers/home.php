...
class Controller extends \Kotchasan\KBase
{
    ...
    public static function addCard(Request $request, $card, $login)
    {
        ...
        if ($datas->isStaff) {
            \Index\Home\Controller::renderCard($card, 'icon-tags', '{LNG_Repair list}', number_format($datas_Alltoday->count), '{LNG_Per Month}', 'index.php?module=repair-setup'); /* '{LNG_Job today}*/
