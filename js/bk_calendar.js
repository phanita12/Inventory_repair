...
Calendar.prototype = {
  initialize: function(id, o) {
    ...
    for (var property in o) {
      ...
      } else if (property == 'minYear') {
        this.minYear = Math.min(o[property], this.minYear);
      } else if (property == 'maxYear') {
        this.maxYear = Math.max(o[property], this.maxYear);
      } else {
    ...
    Object.defineProperty(this, 'min', {
      ...
      set: function(value) {
        self.minYear = Math.min(value, self.minYear);
        self._resize();
      }
    });
    Object.defineProperty(this, 'max', {
      ...
      set: function(value) {
        self.maxYear = Math.max(value, self.maxYear);
        self._resize();
      }
    });
  },
