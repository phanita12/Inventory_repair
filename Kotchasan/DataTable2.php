<?php
/**
 * @filesource Kotchasan/DataTable2.php
 *
 ...
 * @since 1.0
 */
class DataTable2 extends \Kotchasan\KBase
{
                        ...
                        foreach ($this->buttons as $btn => $attributes) {
                            if (isset($this->onCreateButton)) {
                               ...
                               if ($attributes && $attributes !== false) {
                                    if($items ["attachment"] != ''){ 
                                        $btn = 'file_attachment';  
                                        $attributes['class'] = 'button purple notext notext icon-download';
                                        $attributes['id'] = ':id';
                                        $attributes['title'] = '{LNG_File}';
                                   }
    ...
    private function addFilter($item)
    {
        ...
        if (isset($item['type'])) {
            ...
            //if($item['name'] == 'category_id'   ){ $row = '<br>';} //memberstatus
